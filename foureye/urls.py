...
urlpatterns = [
    ...
    url(r'^Predict_Threat_Status_Type/$', remoteuser.Predict_Threat_Status_Type, name="Predict_Threat_Status_Type"),
    ...
    url(r'^View_Threat_Detection_Status_Ratio/$', serviceprovider.View_Threat_Detection_Status_Ratio, name="View_Threat_Detection_Status_Ratio"),
    url(r'^Train_Test_Datasets/$', serviceprovider.Train_Test_Datasets, name="Train_Test_Datasets"),
    url(r'^View_Threat_Detection_Status_Type/$', serviceprovider.View_Threat_Detection_Status_Type, name="View_Threat_Detection_Status_Type"),
